...
EMPTY_TEST_SUITE(HmacSha512Tests);

TEST_F(HmacSha512Tests, HmacTestCase1)
{
    ...
    EXPECT_TRUE(memcmp(result->toUCharArrayPtr(), expectedDigest, 64) == 0);
}

TEST_F(HmacSha512Tests, HmacTestCase2)
{
...
TEST_F(HmacSha512Tests, HmacTestCase3)
{
...
TEST_F(HmacSha512Tests, HmacTestCase4)
{
    size_t keyLength = 25;
...
TEST_F(HmacSha512Tests, HmacTestCase5)
{
...
TEST_F(HmacSha512Tests, HmacTestCase6)
{
    ...
    if ((nullptr == result) || (result->empty())) {
        FAIL() << "HMAC calculation was invalid!";
    }
...
TEST_F(HmacSha512Tests, HmacTestCase7)
{
    ...
    qDebug("Got      : %s", TestUtils::binaryToString(result).c_str());
    EXPECT_TRUE(memcmp(result->toUCharArrayPtr(), expectedDigest1, 64) == 0);
}
