...
TEST_F(HmacSha1Tests, HmacNoHashTest)
{
    ...
    EXPECT_TRUE(invalidHmac.calculate(randomJunk, data) == nullptr);
}

TEST_F(HmacSha1Tests, HmacTestCase1)
{
    ...
    EXPECT_EQ(result->size(), static_cast<size_t>(20));
    qDebug("Expected : %s", TestUtils::binaryToString(expectedDigest, 20).c_str());
    qDebug("Got      : %s", TestUtils::binaryToString(result).c_str());
    EXPECT_TRUE(memcmp(result->toUCharArrayPtr(), expectedDigest, 20) == 0);
}

TEST_F(HmacSha1Tests, HmacTestCase2)
{
...
TEST_F(HmacSha1Tests, HmacTestCase3)
{
...
TEST_F(HmacSha1Tests, HmacTestCase4)
{
    size_t keyLength = 25;
...
TEST_F(HmacSha1Tests, HmacTestCase5)
{
...
TEST_F(HmacSha1Tests, HmacTestCase6)
{
...
TEST_F(HmacSha1Tests, HmacTestCase7)
{
    ...
    qDebug("Got      : %s", TestUtils::binaryToString(result).c_str());
    EXPECT_TRUE(memcmp(result->toUCharArrayPtr(), expectedDigest1, 20) == 0);
}
