      ...
      _attached(false)
{
  ...
  */
  setOpaquePainting(true);
    ...
    //      thread->window.attach(QX11Info::display(), window()->winId());
    //        _attached = 1;
	//}
...
void QZBar::dragEnterEvent (QDragEnterEvent *)
{
    /*
...
void QZBar::dropEvent (QDropEvent *)
{
    /*
    if(event->mimeData()->hasImage()) {
...
void QZBar::showEvent (QShowEvent *)
{
    if(thread && !_attached)
        attach();
}
